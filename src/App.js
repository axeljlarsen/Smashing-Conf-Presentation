...
import { faThunderstorm, faCloudSunRain, faCloudRain, faWind, faSunCloud, faSquare, faCheck, faTrophyAlt, faUsers, faStopwatch, faBicycle, faStroopwafel as farFaStroopwafel } from '@fortawesome/pro-light-svg-icons';
...
library.add([faThunderstorm, faCloudSunRain, faWind, faCloudRain, faSunCloud,faSquare, faCheck, faTrophyAlt,faUsers,faDumbbell,faIgloo,faStopwatch,faBicycle]);
      ...
      <div className="App mod-scale-fluid">
        ...
        <BrowserRouter>
          <Switch>
            ...
            <Route path={AppRoutes.CSSGrid_UG3} exact component={UserGroup} />
